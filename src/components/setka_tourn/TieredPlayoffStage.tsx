                        ...
                        <div className="flex flex-col gap-2.5">
                          ...
                          >
                            <div className="flex items-center gap-2.5 min-w-0 flex-1">
                              <TeamLogo teamName={match.team1?.name || ''} logoUrl={match.team1?.logoUrl} sizeClassName="w-6 h-6 shrink-0" />
                          ...
                          >
                            <div className="flex items-center gap-2.5 min-w-0 flex-1">
                              <TeamLogo teamName={match.team2?.name || ''} logoUrl={match.team2?.logoUrl} sizeClassName="w-6 h-6 shrink-0" />
                              {!isExporting && isSwapMode ? (
                                <select
