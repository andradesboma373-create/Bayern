...
export const CUSTOM_PLAYER_PERKS: PlayerPerk[] = [
  ...
  {
    nickname: "ropz",
    customTitle: "Lurk & Clutch Master 🎯",
    skillMultiplier: 1.06,
    killMultiplier: 1.08,
    deathMultiplier: 0.86,
    assistMultiplier: 0.95,
    clutchBonus: 0.12,
    hsMultiplier: 1.08
  },
  {
    nickname: "b1t",
    customTitle: "Headshot Machine 🎯",
    skillMultiplier: 1.05,
    killMultiplier: 1.07,
    deathMultiplier: 0.90,
    assistMultiplier: 0.96,
    clutchBonus: 0.07,
    hsMultiplier: 1.20
  },
  {
    nickname: "HeavyGod",
    customTitle: "Star Anchor / Support 💥",
    skillMultiplier: 1.06,
    killMultiplier: 1.08,
    deathMultiplier: 0.92,
    assistMultiplier: 1.10,
    clutchBonus: 0.06,
    hsMultiplier: 1.08
  },
  {
    nickname: "Krabeni",
    customTitle: "Fragging Captain 🎖️",
    skillMultiplier: 1.01,
    killMultiplier: 0.98,
    deathMultiplier: 0.98,
    assistMultiplier: 1.15,
    tacticalBonus: 0.05,
    clutchBonus: 0.04
  }
