...
export class MapSystem {
  ...
  static initializeMap(mapId: string) {
    ...
    this.nodes = {
      ...
      'a_main': { id: 'a_main', x: 30, y: 20, zone: 'A_MAIN', connections: ['t_ramp', 'a_site'], visibilityConnections: ['a_site', 't_ramp', 'connector'] },
      ...
      'b_apps': { id: 'b_apps', x: 60, y: 80, zone: 'APARTMENTS', connections: ['b_apps_entrance', 'b_site'], visibilityConnections: ['b_site', 'b_apps_entrance', 'short'] },
      'mid_t_entrance': { id: 'mid_t_entrance', x: 30, y: 50, zone: 'MID', connections: ['t_spawn', 'mid'], visibilityConnections: ['mid'] },
      'connector': { id: 'connector', x: 65, y: 35, zone: 'CONNECTOR', connections: ['mid', 'a_site', 'jungle'], visibilityConnections: ['mid', 'a_site', 'a_main', 'jungle'] },
      'short': { id: 'short', x: 65, y: 65, zone: 'SHORT', connections: ['mid', 'b_site'], visibilityConnections: ['mid', 'b_site', 'b_apps'] },
      'jungle': { id: 'jungle', x: 75, y: 35, zone: 'CONNECTOR', connections: ['ct_spawn', 'a_site', 'connector', 'window'], visibilityConnections: ['a_site', 'window', 'connector'] },
      'window': { id: 'window', x: 70, y: 50, zone: 'MID', connections: ['jungle', 'mid'], visibilityConnections: ['mid', 'jungle', 'connector'] }
    };
